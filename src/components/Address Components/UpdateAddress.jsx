...
export default function UpdateAddress() {
  const { loader, updateAddress, fetchSuccess, getUser, error } =
    useContext(Context);
  ...
  function handleClick(e) {
    e.preventDefault();
    updateAddress(inputValues, addressID);
  }
  ...
  useEffect(() => {
    if (userInfo) {
      userInfo.addressBook.forEach((address) => {
      ...
      {userInfo &&
        (localStorage.getItem("auth-token") ? (
          <>
            ...
            >
              {error.status === 404 &&
                error.message === "user or address not found" &&
                error.error && (
                  <div
                  ...
                  >
                    <i
                      ...
                      style={{ color: "#ff0000" }}
                    ></i>
                    <div>User or Address not found</div>
                  </div>
                )}
            </div>
